...
window.cordovaHTTP = {
    ...
    setHeader: function(header, value) {
        /////////////negar:
        console.log("ghableSet : "+this.headers[header]);
        /////////////
        this.headers[header] = value;
        /////////////negar:
        console.log("bade set : "+this.headers[header]);
        /////////////
    },
    ...
    post: function(url, params, headers, success, failure) {
        ...
        /////////////negar:
        console.log("post/loc : "+this.headers["Location"]);
        console.log("post/to : "+url);
        console.log("post/headers : "+JSON.stringify(this.headers));
    ...
    get: function(url, params, headers, success, failure) {
        headers = mergeHeaders(this.headers, headers);
        /////////////negar:
        console.log("get/loc : "+this.headers["Location"]);
        console.log("get/to : "+url);
        console.log("get/headers bedoone this : "+JSON.stringify(headers));
        /////////////
